...
/*
 *  The ThreadSafeFibonacciHeap class represents a priority queue of generic keys.
 ...
 */
public class ThreadSafeFibonacciHeap<Key> implements Iterable<Key> {
     ...
     */
    public ThreadSafeFibonacciHeap(Comparator<Key> C) {
        comp = C;
    }
     ...
     * Worst case is O(1)
     */
    public ThreadSafeFibonacciHeap() {
     ...
     */
    public ThreadSafeFibonacciHeap(Key[] a) {
        comp = new MyComparator();
     ...
     * @param a an array of keys
     */
    public ThreadSafeFibonacciHeap(Comparator<Key> C, Key[] a) {
        comp = C;
        for (Key k : a) insert(k);
    }
    ...
    private class MyIterator implements Iterator<Key> {
        private ThreadSafeFibonacciHeap<Key> copy;


        //Constructor takes linear time
        public MyIterator() {
            copy = new ThreadSafeFibonacciHeap<Key>(comp);
            insertAll(head);
        }
