...
/*
 *  The FibonacciHeap class represents a priority queue of generic keys.
 ...
 */
public class FunctionalFibonacciHeap<Key> implements Iterable<Key> {
     ...
     */
    public FunctionalFibonacciHeap(Comparator<Key> C) {
        comp = C;
    }

    Function<?, ?> constructor = (Comparator<Key> C) -> comp = C;

    /**
     * Initializes an empty priority queue
     * Worst case is O(1)
     */
    public FunctionalFibonacciHeap() {
        comp = new MyComparator();
    }

    Runnable defaultConstructor = () -> comp = new MyComparator();
     ...
     */
    public FunctionalFibonacciHeap(Key[] a) {
        comp = new MyComparator();
        for (Key k : a) insert(k);
    }

    Function<?, ?> keyConstructor = (Key[] a) -> {
        comp = new MyComparator();
        for (Key k : a) insert(k);
    };
     ...
     * @param a an array of keys
     */
    public FunctionalFibonacciHeap(Comparator<Key> C, Key[] a) {
        comp = C;
        for (Key k : a) insert(k);
    }
     ...
     */
    public FunctionalFibonacciHeap<Key> union(FunctionalFibonacciHeap<Key> that) {
    ...
    private class MyIterator implements Iterator<Key> {
        private FunctionalFibonacciHeap<Key> copy;


        //Constructor takes linear time
        public MyIterator() {
            copy = new FunctionalFibonacciHeap<Key>(comp);
            insertAll(head);
        }
